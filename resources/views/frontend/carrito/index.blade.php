                                ...
                                <div class="col-lg-7">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center mb-4">
                                        <div>
                                            ...
                                            @if (session('carrito'))
                                                <p class="mb-0">Tienes {{ count(session('carrito')) }} productos en la
                                                    cesta</p>
                                            @else
                                                    ...
                                                    <div class="d-flex justify-content-between">
                                                        ...
                                                        <div class="d-flex flex-row align-items-center">
                                                            ...
                                                            <div style="width: 80px;">
                                                                <h5 class="mb-0">
                                                                    {{ $detalles['cantidad'] * $producto->price }}€</h5>
                                                            </div>
                                                            <a href="/frontend/carrito/producto/eliminar/{{ $id }}"
                                            ...
                                            <div class="card bg-primary text-white rounded-3">
                                                <div class="card-body">
                                                    ...
                                                    <div class="form-outline form-white mb-4">
                                                        ...
                                                        <label class="form-label" for="typeName">Propietario de la
                                                            tarjeta</label>
                                                    </div>

                                                    <div class="form-outline form-white mb-4">
                                                        <input type="text" id="typeText"
                                                            class="form-control form-control-lg" value="1234 5678 9012 3457"
                                                            size="16" placeholder="1234 5678 9012 3457" minlength="19"
                                                            maxlength="19" />
                                                    ...
                                                    <div class="row mb-4">
                                                        <div class="col-md-6">
                                                            <div class="form-outline form-white">
                                                                ...
                                                                <label class="form-label" for="typeExp">Fecha
                                                                    expiración</label>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-outline form-white">
                                                                <input required type="password" id="typeText"
                                                                    class="form-control form-control-lg"
                                                                    placeholder="&#9679;&#9679;&#9679;" size="1"
