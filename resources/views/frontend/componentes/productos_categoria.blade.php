...
@section('contenido')
    ...
    <section class="py-5">
        <div>
            ...
            <button class="btn btn-outline-dark flex-shrink-0" type="button" onclick="filtrarCategoria()">
                <i class="bi-cart-fill me-1"></i>
                Filtrar
            </button>
        </div>

        <?php $productos = App\Models\Producto::where('categoria_id', $categoria->id)->get(); ?>
